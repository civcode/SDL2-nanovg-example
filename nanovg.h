...
// Parameters (ox,oy) left-top location of the image pattern,
...
// Scissoring
// ... allows you to clip the rendering into a rectangle. This is useful for
// various user interface cases like rendering a text edit or a timeline.
...
struct NVGparams {
    ...
    int (*renderCreateTexture)(void *uptr, int type, int w, int h,
                               int imageFlags, const unsigned char *data);
    int (*renderDeleteTexture)(void *uptr, int image);
    int (*renderUpdateTexture)(void *uptr, int image, int x, int y, int w,
